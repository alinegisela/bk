...
public class InstituicaoControlador implements Serializable {
    ...
    public void addInsumo(Insumo i) throws ClassNotFoundException {
        MaterialControlador mc = new MaterialControlador();
        MaterialBuilder mb = new MaterialBuilder();
        mb.setPrioridade(true);
        
        InsumoControlador ic = new InsumoControlador();
        i.setCodigo(gerarCodigo());
        //inserir no bd
        ic.inserir(i);
        
        //inserir em table materiais
      //  mc.inserir(mb.build(i.getCodigo(), true), getInstituicaoSelecionada().getCnpj());
        i.setCodigo(0);
        i.setNome("");
        i.setDescricao("");
        i.setTipo("");
         insumoTodos = ic.recuperarTodos();
         
    }
    
     public void addInsumoCadastro(Insumo i) throws ClassNotFoundException {
        MaterialControlador mc = new MaterialControlador();
        MaterialBuilder mb = new MaterialBuilder();
        mb.setPrioridade(true);
